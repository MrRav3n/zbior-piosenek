(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["styles"], {
  ...
  function node_modulesCssLoaderDistCjsJsNode_modulesPostcssLoaderSrcIndexJsNode_modulesSassLoaderDistCjsJsSrcStylesScss(module, exports, __webpack_require__) {
    ...
    exports.push([module.i, "/* You can add global styles to this file, and also import other style files */\nbody, html {\n  margin: 0;\n  height: 100%;\n  font-family: Lato, serif;\n  overflow-x: hidden;\n  scroll-behavior: smooth;\n}\n.choose {\n  padding: 10px;\n  margin: 10px;\n  background: grey;\n  border-radius: 7px;\n  cursor: pointer;\n}\n.bb {\n  border-bottom: 2px solid black !important;\n  padding-bottom: 15px;\n}", "", {
      "version": 3,
      "sources": ["E:\\zespół\\zbior-piosenek/src\\styles.scss", "styles.scss"],
      "names": [],
      "mappings": "AAAA,8EAAA;AACA;EACE,SAAA;EACA,YAAA;EACA,wBAAA;EACA,kBAAA;EAKA,uBAAA;ACHF;ADKA;EACE,aAAA;EACA,YAAA;EACA,gBAAA;EACA,kBAAA;EACA,eAAA;ACFF;ADIA;EACE,yCAAA;EACA,oBAAA;ACDF",
      "file": "styles.scss",
